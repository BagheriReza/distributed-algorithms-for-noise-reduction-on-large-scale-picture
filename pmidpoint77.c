...
unsigned char  window [49],//for window buffer
		x,sum[49],
...
unsigned char array3[w],array4[w],array5[w],array6[w],array7[w];
...
for(j=0;j<(gap+6);j++)//repeat untill of each process size finish
{
if(rank==0){
